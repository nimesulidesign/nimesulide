...
{% assign clean_path = raw_path | replace: '../../', '/' | replace: '../', '/' %}
{% assign first_char = clean_path | slice: 0, 1 %}
{% if first_char != '/' %}{% assign clean_path = clean_path | prepend: '/' %}{% endif %}
{% assign img_src = clean_path | relative_url %}
{% elsif page.content contains 'src="' %}
{% assign img_parts = page.content | split: 'src="' %}
{% assign raw_path = img_parts[1] | split: '"' | first %}
{% assign clean_path = raw_path | replace: '../../', '/' | replace: '../', '/' %}
{% assign first_char = clean_path | slice: 0, 1 %}
{% if first_char != '/' %}{% assign clean_path = clean_path | prepend: '/' %}{% endif %}
